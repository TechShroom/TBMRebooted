...
public class ModelResourceLocation extends ResourceLocation {
    ...
    protected ModelResourceLocation(int p_i46078_1_, String... p_i46078_2_) {
        ...
        this.variant = StringUtils.isEmpty(p_i46078_2_[2]) ? "normal"
                : p_i46078_2_[2].toLowerCase();
        if (toString().contains("drillhead") && !toString().contains("[")) {
            System.err.println("MRL " + toString());
        }
    }
    ...
    public ModelResourceLocation(ResourceLocation p_i46080_1_,
            String p_i46080_2_) {
    ...
    public ModelResourceLocation(String p_i46081_1_, String p_i46081_2_) {
        this(0, parsePathString(p_i46081_1_ + '#'
                + (p_i46081_2_ == null ? "normal" : p_i46081_2_)));
    }
    ...
    protected static String[] parsePathString(String p_177517_0_) {
        ...
        System.arraycopy(ResourceLocation.splitObjectName(s1), 0, astring, 0,
                2);
        return astring;
    }
    ...
    public boolean equals(Object p_equals_1_) {
        if (this == p_equals_1_) {
            return true;
        } else if (p_equals_1_ instanceof ModelResourceLocation
                && super.equals(p_equals_1_)) {
            ModelResourceLocation modelresourcelocation =
                    (ModelResourceLocation) p_equals_1_;
