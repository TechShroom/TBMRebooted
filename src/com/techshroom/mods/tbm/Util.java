...
import static com.techshroom.mods.tbm.Util.SideConstants.BOTTOM;
import static com.techshroom.mods.tbm.Util.SideConstants.EAST;
import static com.techshroom.mods.tbm.Util.SideConstants.NORTH;
import static com.techshroom.mods.tbm.Util.SideConstants.SOUTH;
import static com.techshroom.mods.tbm.Util.SideConstants.TOP;
import static com.techshroom.mods.tbm.Util.SideConstants.WEST;
...
public final class Util {
    ...
    public static int getMetadataForBlock(int x, int y, int z,
        ...
        if (MathHelper.abs((float) entity.posX - (float) x) < 2.0F && MathHelper
                .abs((float) entity.posZ - (float) z) < 2.0F) {
    ...
    public static final class IBS {
        ...
        public static boolean equal(IBlockSource ibs1, IBlockSource ibs2) {
            return ibs1 != null && ibs2 != null
                    && (ibs1 == ibs2 || (ibs1.getWorld() == ibs2.getWorld() && ibs1
                            .getXInt() == ibs2.getXInt()
        ...
        private static Map<Class<? extends IBlockSource>, Constructor<? extends IBlockSource>> constrCache = new HashMap<Class<? extends IBlockSource>, Constructor<? extends IBlockSource>>();

        static {
            @SuppressWarnings("unchecked")
            Constructor<BlockSourceImpl> constr = (Constructor<BlockSourceImpl>) BlockSourceImpl.class
        ...
        private static <T extends IBlockSource> T constr(Class<T> ibs, World w,
            ...
            try {
                ...
                Constructor<? extends IBlockSource> ibsConstr = constrCache
                        .get(ibsClass);
                if (ibsConstr == null) {
                    try {
                        ...
                        System.err
                                .println("[techshroom-util] " + "SecurityException caught, falling back: "
                                        + e.getMessage());
                    } catch (NoSuchMethodException e) {
                        System.err
                                .println("[techshroom-util] " + "Class "
                                        + ibsClass
        ...
        public static int distSq(IBlockSource o1, IBlockSource o2) {
            int xo = o1.getXInt(), yo = o1.getYInt(), zo = o1.getZInt(), xt = o2
                    .getXInt(), yt = o2.getYInt(), zt = o2.getZInt();
            xo = xt - xo;
            yo = yt - yo;
            zo = zt - zo;
    ...
    public static final class Draw {
        ...
        public static void tesselateElementsWIthTextureSpecs(
            ...
            if (texCoords.length < index.length && texCoords.length == verts.length) {
